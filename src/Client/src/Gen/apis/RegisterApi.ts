...
import type { HttpValidationProblemDetails, RegisterRequest } from "../models/index";
import {
...
export interface RegisterApiInterface {
    ...
    ): Promise<runtime.ApiResponse<HttpValidationProblemDetails>>;
    ...
    apiRegisterPost(
        requestParameters: ApiRegisterPostRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction
    ): Promise<HttpValidationProblemDetails>;
}
