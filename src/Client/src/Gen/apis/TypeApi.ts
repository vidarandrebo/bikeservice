...
import type { EquipmentTypeResponse, PostEquipmentTypeRequest } from "../models/index";
import {
...
export interface TypeApiInterface {
     ...
     */
    apiTypeDeleteRaw(
        requestParameters: ApiTypeDeleteRequest,
    ...
    apiTypeGetRaw(
        initOverrides?: RequestInit | runtime.InitOverrideFunction
    ): Promise<runtime.ApiResponse<Array<EquipmentTypeResponse>>>;
     ...
     */
    apiTypePostRaw(
        requestParameters: ApiTypePostRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction
    ): Promise<runtime.ApiResponse<void>>;
...
export class TypeApi extends runtime.BaseAPI implements TypeApiInterface {
    ...
    async apiTypeGet(
        initOverrides?: RequestInit | runtime.InitOverrideFunction
    ): Promise<Array<EquipmentTypeResponse>> {
