...
import type { PartResponse, PostPartRequest, ProblemDetails, PutPartRequest } from "../models/index";
import {
...
export interface PartApiInterface {
     ...
     */
    apiPartDeleteRaw(
        requestParameters: ApiPartDeleteRequest,
    ...
    apiPartGetRaw(
        initOverrides?: RequestInit | runtime.InitOverrideFunction
    ): Promise<runtime.ApiResponse<Array<PartResponse>>>;
     ...
     */
    apiPartPostRaw(
        requestParameters: ApiPartPostRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction
     ...
     */
    apiPartPutRaw(
        requestParameters: ApiPartPutRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction
    ): Promise<runtime.ApiResponse<PartResponse>>;
