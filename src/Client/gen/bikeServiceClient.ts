 ...
 */
export interface BikeServiceClient extends BaseRequestBuilder<BikeServiceClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link BikeServiceClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createBikeServiceClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<BikeServiceClient>(requestAdapter, pathParameters, BikeServiceClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const BikeServiceClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const BikeServiceClientNavigationMetadata: Record<Exclude<keyof BikeServiceClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
